...
%% Ask for a begin session. Returns when/if the other acepts.
...
%% Send an item on the table to be tradded.
...
%% Notify the other fsm we cancelled the trade.
notify_cancel(OtherPid) ->
  gen_fsm:send_all_state_event(OtherPid, camcel).
...
%% This cancel event comes from the client. We must wanr the other
...
%% but for our purposes, outpitting to the shell is enough.
